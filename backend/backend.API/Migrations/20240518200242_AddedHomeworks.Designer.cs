...
namespace backend.API.Migrations
{
    ...
    [Migration("20240518200242_AddedHomeworks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.DAL.Entities.EducationMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EducationMaterial");
                });

            modelBuilder.Entity("backend.DAL.Entities.EducationMaterialGroup", b =>
                {
                    ...
                    b.HasKey("EducationMaterialId", "GroupId");

                    b.HasIndex("GroupId");

                    b.ToTable("EducationMaterialGroup");
                });
            ...
            modelBuilder.Entity("backend.DAL.Entities.Homework", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.DAL.Entities.HomeworkStudent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.DAL.Entities.EducationMaterial", b =>
                {
                    b.HasOne("backend.DAL.Entities.Attachment", "Attachment")
                        .WithMany()
                        .HasForeignKey("AttachmentId");

                    b.HasOne("backend.DAL.Entities.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.DAL.Entities.EducationMaterialGroup", b =>
                {
                    b.HasOne("backend.DAL.Entities.EducationMaterial", "EducationMaterial")
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("backend.DAL.Entities.HomeworkStudent", b =>
                {
                    ...
                    b.HasOne("backend.DAL.Entities.Homework", "Homework")
                        .WithMany("HomeworkStudents")
                        .HasForeignKey("HomeworkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("backend.DAL.Entities.User", "ReviewedBy")
                        .WithMany()
